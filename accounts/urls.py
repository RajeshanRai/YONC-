...
urlpatterns = [
    ...
    path('accounts/moderation/', views.moderation_dashboard_view, name='moderation_dashboard'),
    path('accounts/moderation/unblock/<int:pk>/', views.unblock_moderated_user_view, name='unblock_moderated_user'),
